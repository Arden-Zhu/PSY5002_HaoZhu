...
```
#### Conclusion
**Correlation with Rating (Pre-manipulation)**
Anxiety was not significantly correlated with participants’ pre-manipulation ratings, r(315) = -0.08, p = .18.
...
**Correlation with Distance (Pre-manipulation)**
Anxiety was marginally negatively correlated with distance to the object, r = -0.10, p = .07.
